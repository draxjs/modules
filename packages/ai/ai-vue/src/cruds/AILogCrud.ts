...
class AILogCrud extends EntityCrud implements IEntityCrud {
    ...
    get fields(): IEntityCrudField[] {
        return [
            ...
            {name: 'input', type: 'longString', label: 'input', default: '', groupTab: 'INPUT'},
            {
                name: 'inputImages',
                type: 'array.object',
                label: 'inputImages',
                default: [],
                groupTab: 'FILES',
                objectFields: [{name: 'filename', type: 'string', label: 'filename', default: ''},
            ...
            {name: 'output', type: 'longString', label: 'output', default: '', groupTab: 'OUTPUT'},
    ...
    get tabs() {
        return [
            'REQUEST', 'INPUT','OUTPUT', 'FILES', 'USAGE', 'RESULT', 'MANAGE'
        ]
    }
