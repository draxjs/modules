...
class PersonCrud extends EntityCrud implements IEntityCrud {
  ...
  get headers(): IEntityCrudHeader[] {
    return [
      ...
      {title: 'tenant', key: 'tenant', align: 'start', permission: 'tenant:manage'},
      {title: 'user', key: 'user', align: 'start', permission: 'user:manage'}
    ]
  }
  ...
  get fields(): IEntityCrudField[] {
    return [
      ...
      {name: 'user', type: 'ref', ref: 'User', refDisplay: 'username', label: 'user', default: null, permission: 'user:manage'}
    ]
  }
