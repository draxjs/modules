...
{name:'user',type:'object',label:'user',default:{"id":"''","username":"''","rolName":"''"},objectFields: [{name:'id',type:'string',label:'id',default:''},
...
{name:'changes',type:'array.object',label:'changes',default:[],objectFields: [{name:'field',type:'string',label:'field',default:''},
...
{name:'tenant',type:'object',label:'tenant',default:{"id":"''","name":"''"},objectFields: [{name:'id',type:'string',label:'id',default:''},
