...
const AuditSchema = new mongoose.Schema<IAudit>({
            ...
            rolName: {type: String,   required: true, index: false, unique: false } 
            },
            action: {type: String,   required: true, index: true, unique: false },
            ip: {type: String,   required: true, index: false, unique: false },
            userAgent: {type: String,   required: true, index: false, unique: false },
            changes: [{ 
