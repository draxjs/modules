...
{name:'cards',type:'array.object',label:'cards',default:[],objectFields: [{name:'entity',type:'string',label:'entity',default:''},
{name:'type',type:'enum',label:'type',default:null,enum: ['paginate', 'groupBy']},
{name:'title',type:'string',label:'title',default:''},
{name:'filters',type:'array.object',label:'filters',default:[],objectFields: [{name:'field',type:'string',label:'field',default:''},
{name:'operator',type:'string',label:'operator',default:''},
{name:'value',type:'string',label:'value',default:''}]},
{name:'layout',type:'object',label:'layout',default:{"cols":12,"sm":12,"md":12,"lg":12,"height":100,"cardVariant":"'elevated'"},objectFields: [{name:'cols',type:'number',label:'cols',default:12},
...
{name:'cardVariant',type:'enum',label:'cardVariant',default:'elevated',enum: ['text', 'flat', 'elevated', 'tonal', 'outlined', 'plain']}]},
{name:'groupBy',type:'object',label:'groupBy',default:{"fields":"[]","dateFormat":"'day'","render":"'day'"},objectFields: [{name:'fields',type:'array.string',label:'fields',default:[]},
{name:'dateFormat',type:'enum',label:'dateFormat',default:'day',enum: ['year', 'month', 'day', 'hour', 'minute', 'second']},
{name:'render',type:'enum',label:'render',default:'day',enum: ['table', 'gallery', 'pie', 'bars']}]},
{name:'paginate',type:'object',label:'paginate',default:{"columns":"[]","orderBy":"''","order":null},objectFields: [{name:'columns',type:'array.string',label:'columns',default:[]},
