    ...
    en: {
        validation: {
            ...
            password: {
                ...
                requireSpecialChar: 'Password must contain at least one allowed special character: !\"#$%&\'()*+,-./:;<=>?@[\\]^_`{|}~',
    ...
    es: {
        validation: {
            ...
            password:{
                ...
                requireSpecialChar: 'La contraseña debe contener al menos un caracter especial permitido: !\"#$%&\'()*+,-./:;<=>?@[\\]^_`{|}~',
